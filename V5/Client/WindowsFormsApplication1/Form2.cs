...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            DetectarObjecte(x, y); //detecta si les coordenades en les que estam podem contenir informació
        ...
        {
            if ((x > 490 && x < 510) && (y == 150) && (found1 == false))
            {
                llibre = "Títol llibre";
                found1 = true;
                LlistaPistes.Add(llibre);
            }
            if ((x > 570 && x < 590) && (y == 310) && (found2 == false))
            {
                enigma = "Miquel?";
                found2 = true;
