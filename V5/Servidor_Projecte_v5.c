...
int Elimina_Jugador (Partida *partidas, char nom_desc, int partida)
{

	if(partidas[partida].nombre1 ==nom_desc){
		
		strcpy(partidas[partida].nombre1, "");
		partidas[partida].socket1 = NULL;
	}
	if(partidas[partida].nombre2 ==nom_desc){
		
		strcpy(partidas[partida].nombre2, "");
		partidas[partida].socket2 = NULL;
	}
	if(partidas[partida].nombre3==nom_desc){
		
		strcpy(partidas[partida].nombre3, "");
		partidas[partida].socket3= NULL;
	}
	if(partidas[partida].nombre4 ==nom_desc){
